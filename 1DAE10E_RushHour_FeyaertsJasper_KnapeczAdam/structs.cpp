...
//-----------------------------------------------------------------
// GridBottomLeft Constructors
//-----------------------------------------------------------------
GridBottomLeft::GridBottomLeft(const Point2& cell, const Point2f& pixel)
	: cell{cell}
	  , pixel{pixel}
...
GridBottomLeft::GridBottomLeft()
	: GridBottomLeft(Point2{0, 0}, Point2f{0, 0})
{
}
